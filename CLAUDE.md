...
| **Sessioni operative attive** | **Sessione A** `session_01Gu8ZqDxC8yUi1HDZpwQ1zu` (`claude-sonnet-5`, avviata 27/08 08:32Z): **#41 poi #42** su `release/v0.0.2`. L'ordine non è arbitrario: con P-9 aperto `ci-nightly` muore al primo step (`run: ./start-addon.sh --gpu` su file `100644` dopo `actions/checkout`), quindi la nightly non è mai girata e #42 non sarebbe verificabile |
