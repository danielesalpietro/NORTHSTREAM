...
| **Prossima azione** | **Aprire A-3**, che la Fase 2 ha riclassificato da crescita illimitata a **distruzione silenziosa di dati** (`id=3` con un evento delle 13:41:55Z accanto a `id=27413` con uno delle 12:31Z). Ha priorità sul resto della fase: finché è aperto, i check (a) e (c) del soak falliscono per costruzione e **nessuna misura EVAL è confrontabile** con quelle successive. Poi A-2, A-1 (rimozione del boost keyword) e A-5. **T0.10 va irrobustito prima** di usarlo come progression test di A-1 ([#40](https://github.com/danielesalpietro/NORTHSTREAM/issues/40)). Da decidere con l'owner: modello e suddivisione in sessioni (§7) |
