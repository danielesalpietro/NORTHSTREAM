...
| **Prossima azione** | Assegnare **[#22](https://github.com/danielesalpietro/NORTHSTREAM/issues/22)** (catalogo Trino + memoria: chiude l'altra metà di P-2 ed è il progression test **T0.7** della release) e **[#21](https://github.com/danielesalpietro/NORTHSTREAM/issues/21)** (profiles + `mem_limit`, P-5). Poi [#23](https://github.com/danielesalpietro/NORTHSTREAM/issues/23) (tier misurati + T-PROF, **su ENV-L**: su ENV-W il footprint è un limite superiore) e [#44](https://github.com/danielesalpietro/NORTHSTREAM/issues/44) (esclusività dell'host, **già iniziato** su `feature/soak-harness`: `fe91a74`, `cdde3a7`) |
